...
def check_spelling():
    ...
    cs=Label(root, text="Cotterct text is: ", font=("poppins", 20), bg="#dae6f6", fg="#364971")
    cs.place(x=100, y=250)
    spell.config(text=right)


heading= Label(root, text="Text Analyzer", font=("helvetica, arial", 30, "bold"), bg="#dae6f6", fg="#364971")
